        ...
        <Container className='bg-Craftsmanship' component="div">
                ...
                <Grid container spacing={4}>
                    ...
                    <Grid className='craftContent' item xs={12} md={6}>
                        <Box className='craftConText'>
                            ...
                            From our Cup Sambrani made from pure Benzoin from Indonesia to our Masala Bathi crafted with natural charcoal, 
            ...
            <Box sx={{ marginTop: 15}}>
                <Grid container spacing={4}>
                    ...
                    <Grid item xs={12} md={6}>
                        <img
                            src={`${process.env.PUBLIC_URL}/main-images/Craft-2.png`}
                            alt="craftmanship"
                            className="craft-img"
                        />
                    </Grid>
...
//                 <Grid container spacing={4}>
//                     <Grid>
//                         <img src={`${process.env.PUBLIC_URL}/main-images/craftmanship.png`}
//                             alt="craftmanship"
//                             className='craft-img'/>
//                     </Grid>
